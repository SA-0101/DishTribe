  ...
  if (role === "customer") {
    return (
      <div className='flex flex-wrap justify-between items-center px-6 md:px-10 lg:px-20 py-4 bg-white shadow-md'>
        ...
        <div className='flex items-center gap-4 mt-2 md:mt-0'>
          <h1 className='text-gray-700 font-semibold'>CustomerName</h1>
          ...
          <button onClick={()=>{ localStorage.removeItem('role');navigate('/');}} className='px-4 py-2 text-sm font-semibold text-white bg-red-400 hover:bg-red-500 rounded-md transition duration-300 shadow'>Logout</button>
        </div>
      </div>
    );
  } else if (role === "owner") {
    return (
      <div className='flex flex-wrap justify-between items-center px-6 md:px-10 lg:px-20 py-4 bg-white shadow-md'>
        ...
        <h1 className='text-sm md:text-base text-gray-600 italic'>Your Location</h1>
        <div className='flex items-center gap-4 mt-2 md:mt-0'>
          <h1 className='text-gray-700 font-semibold'>Owner Name</h1>
    ...
    return (
      <div className='flex flex-wrap justify-between items-center px-6 md:px-10 lg:px-20 py-4 bg-white shadow-md'>
        ...
        <h1 className='text-sm md:text-base text-gray-600 italic'>Your Location</h1>
        <div className='flex items-center gap-4 mt-2 md:mt-0'>
          <h1 className='text-gray-700 font-semibold'>Admin Name</h1>
